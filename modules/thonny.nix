...
let
  ...
  pythonVersion = "python${lib.versions.majorMinor pkgs.python3.version}";

  # Thonny plugin that adds Stylix-based themes
  thonnyStylixPlugin = ''
...
in
{
  # Create the thonnycontrib namespace package and plugin
  home.file.".local/lib/${pythonVersion}/site-packages/thonnycontrib/__init__.py".text = ''
    # Namespace package for Thonny plugins
  '';

  home.file.".local/lib/${pythonVersion}/site-packages/thonnycontrib/stylix_theme.py".text =
    thonnyStylixPlugin;
}
